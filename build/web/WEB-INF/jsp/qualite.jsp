    ...
    <body >
        <div class="grid">
            <div class="row ">
                <div class="cell  ">
                    <h1 class="fg-bleu">
                        <b>${empty qualite ? "Nouvelle qualité" : qualite.libelle}</b>
                    </h1>
        ...
        <form id="form1" runat="server" class="grid" method="post" action="QualiteServlet" style="padding-top: 10px ;">
            <div class="row cells3">
                <div class="cell">
                    <label>Code <span class="fg-red">*</span></label>
                    <div class="input-control text full-size" data-role="input">
                        <input name="code" type="text" value="${qualite.code}" required="true">
                        <input name="id" type="hidden" value="${qualite.idqualite}" >
                    </div>
                </div>
                <div class="cell colspan2">
                    <label>Libellé <span class="fg-red">*</span></label>
                    <div class="input-control text full-size" data-role="input">
                        <input name="libelle" type="text" value="${qualite.libelle}" required="true">
                    </div>
                </div>
            </div>
