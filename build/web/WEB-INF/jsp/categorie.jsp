    ...
    <body >
        <div class="grid">
            <div class="row ">
                <div class="cell  ">
                    <h1 class="fg-bleu">
                        <b>${empty categorie ? "Nouvelle categorie" : categorie.libelle}</b>
                    </h1>
        ...
        <form id="form1" runat="server" class="grid" method="post" action="CategorieServlet" style="padding-top: 10px ;">
            <div class="row cells3">
                <div class="cell">
                    <label>Code <span class="fg-red">*</span></label>
                    <div class="input-control text full-size" data-role="input">
                        <input name="code" type="text" value="${categorie.code}" required="true">
                        <input name="id" type="hidden" value="${categorie.idcategorie}" >
                    </div>
                </div>
                <div class="cell colspan2">
                    <label>Libellé <span class="fg-red">*</span></label>
                    <div class="input-control text full-size" data-role="input">
                        <input name="libelle" type="text" value="${categorie.libelle}" required="true">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="cell">
                    <label>Discipline <span class="fg-red">*</span></label>
                    <div class="input-control select full-size" data-role="input">
                        <select name="discipline" required>
                            <c:forEach items="${disciplines}" var="discipline">
                                <option value="${discipline.iddiscipline}" ${discipline.iddiscipline==categorie.discipline.iddiscipline ? 'selected':''}>
                                    ${discipline.libelle}
                                </option>
                            </c:forEach>
                        </select>
