...
public class IndividuServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id != null && !id.isEmpty()) {
            int i = Integer.parseInt(id);
            individu = individuDAO.getFort(i);
        }
        ...
        IndividuPhoto photoASupprimer = null;
        if (individu.getIndividuPhoto() != null) {
            photoASupprimer = individu.getIndividuPhoto();
        }
        ...
        if (photoASupprimer != null) {
            individuPhotoDAO.supprimer(photoASupprimer);
