    ...
    <body >
        <div class="grid">
            <div class="row ">
                <div class="cell  ">
                    <h1 class="fg-bleu">
                        <b>${empty region ? "Nouvelle région" : region.libelle}</b>
                    </h1>
        ...
        <form id="form1" runat="server" class="grid" method="post" action="RegionServlet" style="padding-top: 10px ;">
            <div class="row cells3">
                <div class="cell">
                    <label>Code <span class="fg-red">*</span></label>
                    <div class="input-control text full-size" data-role="input">
                        <input name="code" type="text" value="${region.code}" required="true">
                        <input name="id" type="hidden" value="${region.idregion}" >
                    </div>
                </div>
                <div class="cell colspan2">
                    <label>Libellé <span class="fg-red">*</span></label>
                    <div class="input-control text full-size" data-role="input">
                        <input name="libelle" type="text" value="${region.libelle}" required="true">
                    </div>
                </div>
            </div>
