...
<html>
    <head>
        ...
        <script>
            ...
            function loadPhoto(id, i){
                var time = new Date().getTime();
                $("#cadre").fadeTo( "slow" , 0.5);
                $("#cadre").load("IndividuPhotoServlet?id=" + id + "&time=" + time, function () {
                    $("#cadre").fadeTo( "slow" , 1);
                    console.log("Chargement de la photo effectué");
                });
            }
            
            $(document).ready(function(){
                console.log("Je suis beau");
                loadPhoto(${individu.idindividu}, 0);
            });
    ...
    <body >
        <div class="grid">
            <div class="row cells6">
                <div class="cell" id="cadre" style="cursor : pointer; padding: 1px; border: 1px solid #f09433;border-radius: 0px ; min-height: 100px;">
                    <img  id="blah" src="img/user.png" class="bd-white muan" style="border: 2px solid">
                </div>
                <div class="cell colspan5">
                    ...
                    <div class="fg-or" style="font-size: 1.2em; padding-bottom: 5px;">
                        <b>
