...
<html>
                    ...
                    buttons: [
                        {
                            ...
                            className: 'nouveau',
                            action : function(){
                                metroDialog.open('#dialog-qualite');
                            }
                        },
                        {
                            extend: 'excel',
    ...
    <body>
        <div class="grid condensed" style="margin: 0px;">
            ...
            <div id="affichageTableau" class="row cells4" style="padding-right: 20px; padding-top: 20px;">
                <table id="historique" class="dataTable" style="margin-bottom: 10px;">
                    ...
                    <tbody>
                        <c:forEach items="${qualites}" var="d" varStatus="loop">
                            <tr onclick="metroDialog.open('#dialog-qualite${d.idqualite}');">
                                <td>${loop.count}</td>
                                <td>
        ...
        <div data-role="dialog" id="dialog-qualite" class="bg-white padding20"
             data-close-button="true"
             data-windows-style="false"
             data-href="QualiteServlet?temps=${temps}"
             data-overlay="true"
             data-color="fg-dark"
        ...
        <c:forEach items="${qualites}" var="d">
            <div data-role="dialog" id="dialog-qualite${d.idqualite}" class="bg-white padding20"
                 data-close-button="true"
                 data-windows-style="false"
                 data-href="QualiteServlet?id=${d.idqualite}&temps=${temps}"
                 data-overlay="true"
                 data-color="fg-dark"
                 data-width="600"
                 data-overlay-color="overlay-bleu"
