                    ...
                    buttons: [
                        {
                            ...
                            className: 'nouveau',
                            action : function(){
                                metroDialog.open('#dialog-profil');
                            }
                        },
                        {
                            extend: 'excel',
    ...
    <body>
        <div class="grid condensed" style="margin: 0px;">
            ...
            <div style="padding-top: 10px; padding-right: 0px" >
                ...
                <div>
                    <select class="muanza" name="region" class="js-select" ${sessionScope.utilisateur.utilisateurProfil.idutilisateurProfil==1? "":"disabled"}>
            ...
            <div style="padding-top: 10px; padding-bottom: 20px; padding-right: 15px;">
                <button onclick="reinit();" class="button fg-white bg-bleu" style="background-color: #1b4e9c">
                    Reinitialiser
                </button>
