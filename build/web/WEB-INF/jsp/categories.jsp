...
<html>
                    ...
                    buttons: [
                        {
                            ...
                            className: 'nouveau',
                            action : function(){
                                metroDialog.open('#dialog-categorie');
                            }
                        },
                        {
                            extend: 'excel',
    ...
    <body>
                ...
                <table id="historique" class="dataTable" style="margin-bottom: 10px;">
                    ...
                    <tbody>
                        <c:forEach items="${categories}" var="d" varStatus="loop">
                            <tr onclick="metroDialog.open('#dialog-categorie{d.idcategorie}');">
                                <td>${loop.count}</td>
                                <td>${d.discipline.libelle}</td>
                                <td>
        ...
        <div data-role="dialog" id="dialog-categorie" class="bg-white padding20"
             data-close-button="true"
             data-windows-style="false"
             data-href="CategorieServlet?temps=${temps}"
             data-overlay="true"
             data-color="fg-dark"
             data-width="600"
        ...
        <c:forEach items="${categories}" var="d">
            <div data-role="dialog" id="dialog-categorie{d.idcategorie}" class="bg-white padding20"
                 data-close-button="true"
                 data-windows-style="false"
                 data-href="CategorieServlet?id=${d.idcategorie}&temps=${temps}"
                 data-overlay="true"
                 data-color="fg-dark"
                 data-width="600"
                 data-overlay-color="overlay-bleu"
