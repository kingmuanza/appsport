...
@WebServlet(name = "IndividuVoirServlet", urlPatterns = {"/IndividuVoirServlet"})
public class IndividuVoirServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/individu_voir.jsp").forward(request, response);
    }
