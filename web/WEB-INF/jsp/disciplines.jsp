...
<html>
    ...
    <body>
                ...
                <table id="historique" class="dataTable" style="margin-bottom: 10px;">
                    ...
                    <tbody>
                        <c:forEach items="${disciplines}" var="d" varStatus="loop">
                            <tr onclick="metroDialog.open('#dialog-discipline${d.iddiscipline}');">
                                <td>${loop.count}</td>
                                <td>
        ...
        <div data-role="dialog" id="dialog-discipline" class="bg-white padding20"
             ...
             data-href="DisciplineServlet?temps=${temps}"
             data-overlay="true"
             data-color="fg-dark"
        ...
        <c:forEach items="${disciplines}" var="d">
            <div data-role="dialog" id="dialog-discipline${d.iddiscipline}" class="bg-white padding20"
                 data-close-button="true"
                 data-windows-style="false"
                 data-href="DisciplineServlet?id=${d.iddiscipline}&temps=${temps}"
                 data-overlay="true"
                 data-color="fg-dark"
                 data-width="600"
                 data-overlay-color="overlay-bleu"
